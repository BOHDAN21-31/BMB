...
const products = [
    { name: 'Мої замовлення', description: 'Speak directly to your customers', href: '#', icon: CursorArrowRaysIcon },
    { name: 'Отримати Сценарій', description: 'Your customers’ data will be safe and secure', href: '#', icon: FingerPrintIcon },
    { name: 'Профіль', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
]
const callsToAction = [
    { name: 'Топ виконавці', href: '#', icon: PlayCircleIcon },
    { name: 'Тех. підтримка', href: '#', icon: PhoneIcon },
]
        ...
        <header className="bg-gray-900">
            <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
                ...
                <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                    ...
                    <Link to="/manifestPage" className="text-sm/6 font-semibold text-white">
                        Маніфест
                    </Link>
                    <a href="#" className="text-sm/6 font-semibold text-white">
                        Мапа людей
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <Link to="/EnterPage" className="text-sm/6 font-semibold text-white">
                        Вхід <span aria-hidden="true">&rarr;</span>
                    </Link>
                </div>
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <Link  to="/Register"  className="text-sm/6 font-semibold text-white">
                        Реестрація <span aria-hidden="true">&rarr;</span>
                    </Link>
                </div>
            </nav>
